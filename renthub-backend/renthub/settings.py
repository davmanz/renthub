...
AXES_FAILURE_LIMIT = os.environ.get("AXES_FAILURE_LIMIT", 5)  # Limite de intentos fallidos
AXES_COOLOFF_TIME = os.environ.get("AXES_COOLOFF_TIME", 1)
AXES_LOCKOUT_PARAMETERS = [os.environ.get("AXES_LOCKOUT_PARAMETERS"), "ip_address"]  # Bloqueo por IP
AXES_RESET_ON_SUCCESS = os.environ.get("AXES_RESET_ON_SUCCESS", True)  # Resetea intentos después de un login exitoso
